...
-- SELECT * es útil para explorar inicialmente una tabla y conocer todas sus columnas y datos.
-- En producción no es recomendable utilizarlo de forma habitual, ya que puede traer información innecesaria, afectar el rendimiento y hacer más difícil el mantenimiento de las consultas.
...
-- Se seleccionan únicamente los datos necesarios para identificar al cliente, el producto y el monto total de cada venta.
...
-- Se utilizan alias para presentar nombres de columnas más claros para usuarios que no conocen la estructura técnica de la base de datos.
